...
object RoleDetectionStructuredExample extends IOApp.Simple:
  ...
  def run: IO[Unit] =
    for
      ...
      message2 =
        "I've reviewed ticket #12345 and escalated it to our shipping department. I'll follow up with the customer within 24 hours."
      ...
      message3 =
        "Team, I need everyone to review our Q4 support metrics. Let's discuss strategies to improve response times in tomorrow's meeting."
