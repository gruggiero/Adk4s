# tools-node Specification

## Purpose
TBD - created by archiving change add-tools-node. Update Purpose after archive.
## Requirements
...
- **WHEN** tool is executed with string arguments
- **THEN** tool.run method is called
