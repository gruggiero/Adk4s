# graph-orchestration-hybrid-approach Specification

## Purpose

Direct implementation of ADR-003.

This change keeps ADK4S `Graph` as the primary orchestration API and integrates selected LLM4S orchestration capabilities via bridges and utilities.
